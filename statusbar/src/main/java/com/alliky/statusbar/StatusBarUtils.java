...
import static com.alliky.statusbar.Constants.FLAG_FITS_DEFAULT;
import static com.alliky.statusbar.Constants.FLAG_FITS_STATUS;
import static com.alliky.statusbar.Constants.FLAG_FITS_SYSTEM_WINDOWS;
import static com.alliky.statusbar.Constants.FLAG_FITS_TITLE;
import static com.alliky.statusbar.Constants.FLAG_FITS_TITLE_MARGIN_TOP;
import static com.alliky.statusbar.Constants.IMMERSION_ID_NAVIGATION_BAR_VIEW;

/**
 * @Description TODO
 * @Author wxianing
 * @Date 2021/3/12 0012 14:23
 * @Version 1.0
 */
@TargetApi(Build.VERSION_CODES.KITKAT)
public final class StatusBarUtils implements StatusBarCallback {
    ...
    private StatusBarUtils mParentBar;
     ...
     */
    public static StatusBarUtils with(@NonNull Activity activity) {
     ...
     * @return the immersion bar
     */
    public static StatusBarUtils with(@NonNull Fragment fragment) {
     ...
     * @return the immersion bar
     */
    public static StatusBarUtils with(@NonNull Fragment fragment, boolean isOnly) {
     ...
     * @return the immersion bar
     */
    public static StatusBarUtils with(@NonNull DialogFragment dialogFragment) {
     ...
     * @return the immersion bar
     */
    public static StatusBarUtils with(@NonNull Activity activity, @NonNull Dialog dialog) {
     ...
     * @param activity the activity
     */
    StatusBarUtils(Activity activity) {
        mIsActivity = true;
        mActivity = activity;
     ...
     * @param fragment the fragment
     */
    StatusBarUtils(Fragment fragment) {
        mIsFragment = true;
     ...
     * @param fragment the fragment
     */
    StatusBarUtils(android.app.Fragment fragment) {
        mIsFragment = true;
        mActivity = fragment.getActivity();
        mFragment = fragment;
        checkInitWithActivity();
     ...
     * @param dialogFragment the dialog fragment
     */
    StatusBarUtils(DialogFragment dialogFragment) {
        mIsDialog = true;
     ...
     * @param dialogFragment the dialog fragment
     */
    StatusBarUtils(android.app.DialogFragment dialogFragment) {
        mIsDialog = true;
        mIsDialogFragment = true;
        mActivity = dialogFragment.getActivity();
     ...
     * @param dialog   the dialog
     */
    StatusBarUtils(Activity activity, Dialog dialog) {
        mIsDialog = true;
        mActivity = activity;
        mDialog = dialog;
        checkInitWithActivity();
     ...
     * @return the immersion bar
     */
    public StatusBarUtils transparentStatusBar() {
     ...
     * @return the immersion bar
     */
    public StatusBarUtils transparentNavigationBar() {
     ...
     * @return the immersion bar
     */
    public StatusBarUtils transparentBar() {
        mBarParams.statusBarColor = Color.TRANSPARENT;
        mBarParams.navigationBarColor = Color.TRANSPARENT;
        mBarParams.fullScreen = true;
        return this;
     ...
     * @return the immersion bar
     */
    public StatusBarUtils statusBarColor(@ColorRes int statusBarColor) {
     ...
     * @return the immersion bar
     */
    public StatusBarUtils statusBarColor(String statusBarColor) {
     ...
     * @return the immersion bar
     */
    public StatusBarUtils statusBarColorInt(@ColorInt int statusBarColor) {
     ...
     * @return the immersion bar
     */
    public StatusBarUtils navigationBarColor(@ColorRes int navigationBarColor) {
     ...
     * @return the immersion bar
     */
    public StatusBarUtils navigationBarColor(String navigationBarColor) {
     ...
     * @return the immersion bar
     */
    public StatusBarUtils navigationBarColorInt(@ColorInt int navigationBarColor) {
     ...
     * @return the immersion bar
     */
    public StatusBarUtils barColor(@ColorRes int barColor) {
     ...
     * @return the immersion bar
     */
    public StatusBarUtils barColor(@ColorRes int barColor, @FloatRange(from = 0f, to = 1f) float barAlpha) {
     ...
     * @return the immersion bar
     */
    public StatusBarUtils barColor(String barColor) {
     ...
     * @return the immersion bar
     */
    public StatusBarUtils barColor(String barColor, @FloatRange(from = 0f, to = 1f) float barAlpha) {
     ...
     * @return the immersion bar
     */
    public StatusBarUtils barColorInt(@ColorInt int barColor) {
     ...
     * @return the immersion bar
     */
    public StatusBarUtils barColorInt(@ColorInt int barColor, @FloatRange(from = 0f, to = 1f) float barAlpha) {
        mBarParams.statusBarColor = barColor;
        mBarParams.navigationBarColor = barColor;
     ...
     * @return the immersion bar
     */
    public StatusBarUtils statusBarColorTransform(@ColorRes int statusBarColorTransform) {
     ...
     * @return the immersion bar
     */
    public StatusBarUtils statusBarColorTransform(String statusBarColorTransform) {
     ...
     * @return the immersion bar
     */
    public StatusBarUtils statusBarColorTransformInt(@ColorInt int statusBarColorTransform) {
        mBarParams.statusBarColorTransform = statusBarColorTransform;
        return this;
    }
     ...
     * @return the immersion bar
     */
    public StatusBarUtils navigationBarColorTransform(@ColorRes int navigationBarColorTransform) {
     ...
     * @return the immersion bar
     */
    public StatusBarUtils navigationBarColorTransform(String navigationBarColorTransform) {
     ...
     * @return the immersion bar
     */
    public StatusBarUtils navigationBarColorTransformInt(@ColorInt int navigationBarColorTransform) {
        mBarParams.navigationBarColorTransform = navigationBarColorTransform;
        return this;
    }
     ...
     * @return the immersion bar
     */
    public StatusBarUtils barColorTransform(@ColorRes int barColorTransform) {
     ...
     * @return the immersion bar
     */
    public StatusBarUtils barColorTransform(String barColorTransform) {
     ...
     * @return the immersion bar
     */
    public StatusBarUtils barColorTransformInt(@ColorInt int barColorTransform) {
        mBarParams.statusBarColorTransform = barColorTransform;
        mBarParams.navigationBarColorTransform = barColorTransform;
        return this;
    }
     ...
     * @return the immersion bar
     */
    public StatusBarUtils addViewSupportTransformColor(View view) {
     ...
     * @return the immersion bar
     */
    public StatusBarUtils addViewSupportTransformColor(View view, @ColorRes int viewColorAfterTransform) {
     ...
     * @return the immersion bar
     */
    public StatusBarUtils addViewSupportTransformColor(View view, @ColorRes int viewColorBeforeTransform,
     ...
     * @return the immersion bar
     */
    public StatusBarUtils addViewSupportTransformColor(View view, String viewColorAfterTransform) {
     ...
     * @return the immersion bar
     */
    public StatusBarUtils addViewSupportTransformColor(View view, String viewColorBeforeTransform,
     ...
     * @return the immersion bar
     */
    public StatusBarUtils addViewSupportTransformColorInt(View view, @ColorInt int viewColorAfterTransform) {
        if (view == null) {
     ...
     * @return the immersion bar
     */
    public StatusBarUtils addViewSupportTransformColorInt(View view, @ColorInt int viewColorBeforeTransform,
     ...
     * @return the immersion bar
     */
    public StatusBarUtils viewAlpha(@FloatRange(from = 0f, to = 1f) float viewAlpha) {
     ...
     * @return the immersion bar
     */
    public StatusBarUtils removeSupportView(View view) {
        if (view == null) {
            throw new IllegalArgumentException("View参数不能为空");
        }
     ...
     * @return the immersion bar
     */
    public StatusBarUtils removeSupportAllView() {
        if (mBarParams.viewMap.size() != 0) {
     ...
     * @return the immersion bar
     */
    public StatusBarUtils fullScreen(boolean isFullScreen) {
     ...
     * @return the immersion bar
     */
    public StatusBarUtils statusBarAlpha(@FloatRange(from = 0f, to = 1f) float statusAlpha) {
     ...
     * @return the immersion bar
     */
    public StatusBarUtils navigationBarAlpha(@FloatRange(from = 0f, to = 1f) float navigationAlpha) {
        mBarParams.navigationBarAlpha = navigationAlpha;
     ...
     * @return the immersion bar
     */
    public StatusBarUtils barAlpha(@FloatRange(from = 0f, to = 1f) float barAlpha) {
        mBarParams.statusBarAlpha = barAlpha;
     ...
     * @return the immersion bar
     */
    public StatusBarUtils autoDarkModeEnable(boolean isEnable) {
     ...
     * @return the immersion bar
     */
    public StatusBarUtils autoDarkModeEnable(boolean isEnable, @FloatRange(from = 0f, to = 1f) float autoDarkModeAlpha) {
     ...
     * @return the immersion bar
     */
    public StatusBarUtils autoStatusBarDarkModeEnable(boolean isEnable) {
     ...
     * @return the immersion bar
     */
    public StatusBarUtils autoStatusBarDarkModeEnable(boolean isEnable, @FloatRange(from = 0f, to = 1f) float autoDarkModeAlpha) {
        mBarParams.autoStatusBarDarkModeEnable = isEnable;
        mBarParams.autoStatusBarDarkModeAlpha = autoDarkModeAlpha;
        return this;
    }
     ...
     * @return the immersion bar
     */
    public StatusBarUtils autoNavigationBarDarkModeEnable(boolean isEnable) {
     ...
     * @return the immersion bar
     */
    public StatusBarUtils autoNavigationBarDarkModeEnable(boolean isEnable, @FloatRange(from = 0f, to = 1f) float autoDarkModeAlpha) {
        mBarParams.autoNavigationBarDarkModeEnable = isEnable;
        mBarParams.autoNavigationBarDarkModeAlpha = autoDarkModeAlpha;
        return this;
    }
     ...
     * @return the immersion bar
     */
    public StatusBarUtils statusBarDarkFont(boolean isDarkFont) {
     ...
     * @return the immersion bar
     */
    public StatusBarUtils statusBarDarkFont(boolean isDarkFont, @FloatRange(from = 0f, to = 1f) float statusAlpha) {
     ...
     * @return the immersion bar
     */
    public StatusBarUtils navigationBarDarkIcon(boolean isDarkIcon) {
     ...
     * @return the immersion bar
     */
    public StatusBarUtils navigationBarDarkIcon(boolean isDarkIcon, @FloatRange(from = 0f, to = 1f) float navigationAlpha) {
     ...
     * @return the immersion bar
     */
    public StatusBarUtils flymeOSStatusBarFontColor(@ColorRes int flymeOSStatusBarFontColor) {
     ...
     * @return the immersion bar
     */
    public StatusBarUtils flymeOSStatusBarFontColor(String flymeOSStatusBarFontColor) {
     ...
     * @return the immersion bar
     */
    public StatusBarUtils flymeOSStatusBarFontColorInt(@ColorInt int flymeOSStatusBarFontColor) {
     ...
     * @return the immersion bar
     */
    public StatusBarUtils hideBar(BarHide barHide) {
     ...
     * @return the immersion bar
     */
    public StatusBarUtils applySystemFits(boolean applySystemFits) {
     ...
     * @return the immersion bar
     */
    public StatusBarUtils fitsSystemWindows(boolean fits) {
     ...
     * @return the immersion bar
     */
    public StatusBarUtils fitsSystemWindows(boolean fits, @ColorRes int contentColor) {
     ...
     * @return the immersion bar
     */
    public StatusBarUtils fitsSystemWindowsInt(boolean fits, @ColorInt int contentColor) {
     ...
     * @return the immersion bar
     */
    public StatusBarUtils fitsLayoutOverlapEnable(boolean fitsLayoutOverlapEnable) {
     ...
     * @return the immersion bar
     */
    public StatusBarUtils statusBarView(View view) {
        if (view == null) {
            return this;
        }
     ...
     * @return the immersion bar
     */
    public StatusBarUtils statusBarView(@IdRes int viewId) {
     ...
     * @return the immersion bar
     */
    public StatusBarUtils statusBarView(@IdRes int viewId, View rootView) {
     ...
     * @return the immersion bar
     */
    public StatusBarUtils titleBar(View view) {
        if (view == null) {
            return this;
        }
     ...
     * @return the immersion bar
     */
    public StatusBarUtils titleBar(View view, boolean statusBarColorTransformEnable) {
        if (view == null) {
            return this;
        }
        if (mFitsStatusBarType == FLAG_FITS_DEFAULT) {
     ...
     * @return the immersion bar
     */
    public StatusBarUtils titleBar(@IdRes int viewId) {
     ...
     * @return the immersion bar
     */
    public StatusBarUtils titleBar(@IdRes int viewId, boolean statusBarColorTransformEnable) {
     ...
     * @return the immersion bar
     */
    public StatusBarUtils titleBar(@IdRes int viewId, View rootView) {
     ...
     * @return the immersion bar
     */
    public StatusBarUtils titleBar(@IdRes int viewId, View rootView, boolean statusBarColorTransformEnable) {
     ...
     * @return the immersion bar
     */
    public StatusBarUtils titleBarMarginTop(@IdRes int viewId) {
        if (mSupportFragment != null && mSupportFragment.getView() != null) {
     ...
     * @return the immersion bar
     */
    public StatusBarUtils titleBarMarginTop(@IdRes int viewId, View rootView) {
     ...
     * @return the immersion bar
     */
    public StatusBarUtils titleBarMarginTop(View view) {
        if (view == null) {
            return this;
        }
        if (mFitsStatusBarType == FLAG_FITS_DEFAULT) {
     ...
     * @return the immersion bar
     */
    public StatusBarUtils supportActionBar(boolean isSupportActionBar) {
     ...
     * @return the immersion bar
     */
    public StatusBarUtils statusBarColorTransformEnable(boolean statusBarColorTransformEnable) {
        mBarParams.statusBarColorEnabled = statusBarColorTransformEnable;
        return this;
    }
     ...
     * @return the bar tag
     */
    public StatusBarUtils addTag(String tag) {
        if (isEmpty(tag)) {
     ...
     * @return the immersion bar
     */
    public StatusBarUtils getTag(String tag) {
        if (isEmpty(tag)) {
            throw new IllegalArgumentException("tag不能为空");
        }
     ...
     * @return the immersion bar
     */
    public StatusBarUtils keyboardEnable(boolean enable) {
     ...
     * @return the immersion bar
     */
    public StatusBarUtils keyboardEnable(boolean enable, int keyboardMode) {
     ...
     * @return the immersion bar
     */
    public StatusBarUtils keyboardMode(int keyboardMode) {
        mBarParams.keyboardMode = keyboardMode;
        return this;
    }
     ...
     */
    public StatusBarUtils setOnKeyboardListener(@Nullable OnKeyboardListener onKeyboardListener) {
     ...
     */
    public StatusBarUtils setOnNavigationBarListener(OnNavigationBarListener onNavigationBarListener) {
     ...
     */
    public StatusBarUtils setOnBarListener(OnBarListener onBarListener) {
     ...
     * @return the immersion bar
     */
    public StatusBarUtils navigationBarEnable(boolean navigationBarEnable) {
     ...
     * @return the immersion bar
     */
    public StatusBarUtils navigationBarWithKitkatEnable(boolean navigationBarWithKitkatEnable) {
     ...
     * @return the immersion bar
     */
    public StatusBarUtils navigationBarWithEMUI3Enable(boolean navigationBarWithEMUI3Enable) {
        //是否可以修改emui3系列手机导航栏
     ...
     * @return the immersion bar
     */
    public StatusBarUtils barEnable(boolean barEnable) {
