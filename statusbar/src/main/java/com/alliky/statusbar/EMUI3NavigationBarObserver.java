...
import static com.alliky.statusbar.Constants.IMMERSION_EMUI_NAVIGATION_BAR_HIDE_SHOW;

/**
 * @Description TODO
 * @Author wxianing
 * @Date 2021/3/12 0012 14:46
 * @Version 1.0
 */
public final class EMUI3NavigationBarObserver extends ContentObserver {
    private ArrayList<StatusBarCallback> mCallbacks;
    ...
    public void onChange(boolean selfChange) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.JELLY_BEAN_MR1 && mApplication != null && mApplication.getContentResolver() != null
            ...
            for (StatusBarCallback callback : mCallbacks) {
                callback.onNavigationBarChange(show != 1);
            }
        }
    }

    void addOnNavigationBarListener(StatusBarCallback callback) {
        if (callback == null) {
            return;
        }
        if (mCallbacks == null) {
    ...
    void removeOnNavigationBarListener(StatusBarCallback callback) {
